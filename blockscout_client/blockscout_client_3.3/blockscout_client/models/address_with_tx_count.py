...
T = TypeVar("T", bound="AddressWithTxCount")


@_attrs_define
class AddressWithTxCount:
    """
    Attributes:
        hash_ (str):  Example: 0xEb533ee5687044E622C69c58B1B12329F56eD9ad.
        transaction_count (str):  Example: 1234.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        address_with_tx_count.additional_properties = d
        return address_with_tx_count
