...
if TYPE_CHECKING:
    from ..models.health_check_response_metadata import HealthCheckResponseMetadata
...
class HealthCheckResponse:
    ...
    Attributes:
        ...
        metadata (Union[Unset, HealthCheckResponseMetadata]):
    """

    healthy: Union[Unset, bool] = UNSET
    metadata: Union[Unset, "HealthCheckResponseMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = HealthCheckResponseMetadata.from_dict(_metadata)
