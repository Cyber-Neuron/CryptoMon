...
T = TypeVar("T", bound="AddressNFTInstanceMetadata")


@_attrs_define
class AddressNFTInstanceMetadata:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        address_nft_instance_metadata = cls()

        address_nft_instance_metadata.additional_properties = d
        return address_nft_instance_metadata
