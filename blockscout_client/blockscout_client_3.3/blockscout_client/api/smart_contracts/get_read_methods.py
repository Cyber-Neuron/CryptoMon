...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/smart-contracts/{address_hash}/methods-read",
        "params": params,
    }
...
) -> Optional[Union[Any, list[Union["ReadMethodWithValue", "ReadMethodWithoutValue"]]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, list[Union["ReadMethodWithValue", "ReadMethodWithoutValue"]]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, list[Union['ReadMethodWithValue', 'ReadMethodWithoutValue']]]
    """
