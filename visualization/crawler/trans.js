...
//https://capi.coinglass.com/api/v2/kline?diff=false&minLimit=false&limit=300&interval=h24&symbol=ALL%23BTC%23aggregated_spot_buy_sell_usd
//https://capi.coinglass.com/api/v2/kline?diff=false&minLimit=false&limit=300&interval=h24&symbol=ALL%23BTC%23aggregated_buy_sell_usd
const option_Url = 'https://capi.coinglass.com/api/v2/kline?diff=false&minLimit=false&limit=30&interval=m5&symbol=ALL%23ETH%23aggregated_spot_buy_sell_usd';
...
async function main() {
  ...
  const fakeResp = {
    ...
    config: { url: '/api/block/transaction/history', baseURL: 'https://capi.coinglass.com' },
    data: { data: data.data }
  };
  // 解密并输出详细内容
